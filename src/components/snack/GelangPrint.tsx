        ...
        {team.members.map((m) => (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1 px-3 pt-1 pb-3 text-center">
              <span
                className={`rounded-full bg-white/80 px-2 py-0.5 text-[8px] font-bold uppercase tracking-wider ${colors.text} ${colors.ring} border`}
              >
              ...
              {/* Kode tim */}
              <p className={`text-[9px] font-bold uppercase tracking-wider ${colors.text}`}>
                {team.kode}
              </p>
              ...
              {/* Event label */}
              <p className="text-[7px] font-semibold text-muted-foreground/40 uppercase tracking-widest">
                HUT RI ke-81
              </p>
            </div>
          </div>
