...
export function deadlineInfo(deadline: string | null, now = new Date()): { closed: boolean; daysLeft: number | null } {
  ...
  if (closed) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>Tenggat penilaian sudah lewat ({formatDate(deadline)}). Penilaian baru tidak bisa dikirim. Hubungi admin bila ada koreksi.</AlertDescription>
      </Alert>
    )
  }
  return (
