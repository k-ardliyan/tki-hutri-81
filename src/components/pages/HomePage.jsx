...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // gsap.from() sets opacity:0 as inline style immediately. If the tween is
      // interrupted (tab switch, fast re-render), elements stay stuck invisible.
      // gsap.fromTo() + clearProps:'all' guarantees:
      //   - Normal completion → inline styles cleared, CSS takes over (element visible)
      //   - Interrupted mid-flight → element partially visible, NOT completely hidden
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative min-h-[220px] overflow-hidden border-t border-slate-100 sm:min-h-[260px] lg:border-l lg:border-t-0">
            ...
            <div
              ...
              className="absolute bottom-4 right-4 flex items-center gap-3.5 rounded-2xl border border-white/15 bg-slate-950/90 p-4 text-white shadow-2xl backdrop-blur-md"
            >
      ...
      <section className="space-y-5 rounded-[32px] border border-slate-200/80 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="relative pt-2">
          ...
          <div className="hidden lg:block absolute top-[2.25rem] left-[10%] right-[10%] h-0.5">
            <div
              ref={timelineLineRef}
              className="h-full w-full border-t-2 border-dashed border-rose-300"
            />
          </div>
