...
import { logout, getSession } from '../../server/functions/auth'
...
export default function AppShell({
  ...
  useEffect(() => {
    void getSession().then((s) => setUserLabel({ username: s.username ?? undefined, role: s.role ?? undefined }))
  }, [])
  ...
  return (
    ...
    <SidebarProvider>
      <AppSidebar
        ...
        roleLabel={userLabel.role ? ROLE_LABELS[userLabel.role as keyof typeof ROLE_LABELS] : undefined}
        dark={dark}
