...
export const teamMemberNamesSeed: Record<string, string[]> = {
  ...
  'Tim Putra 9': ['MUHAMMAD RIDWAN ADZAHABI', 'RAMA SATYO SASONGKO', 'BARRA RIZKY WIDIYANTO', 'MUHAMAD DAVA ALGHAZALI', 'MAHATMA RAFI NAYAKA', 'BILAL HAMZAH ARDIANSYAH'],
  'Tim Putra 10': ['AHMAD FAISAL', 'ORLANDO KENZO LIONEL PUTRA', 'HIMAS ARYA RAHMADHANI', 'MUHAMMAD ALDY WIBISONO', 'AHMAD AZIZY AFIFUDIN'],
  // ── PKL Putri (random seed 20260807) ──
  'Tim Putri 6': ['AUDIA AL FARIZA', 'KAHNA AYATIN NUJMI', 'SERLI WULAN SAFITRI', 'TALITHA ARISTAWATI', 'CITA CHOTMILLATI', 'EKA SYIFA NABILAH'],
  'Tim Putri 7': ['EKA YULIANTI', 'AZZAHRA PUTRI DESTITA', 'ADINDA TIFANI KARUNIA', 'TIYAS STYANINGRUM', "ATSNA MAULIDA QUROTIL 'AINI", 'DANIAL MAULIDIA'],
...
export const auditNames = ['Arif Arinto', 'Ferry Adi Setyawan', 'Agung Putro Setiawan', 'Yudi Kurniawan', 'Raden Roro Dwi Irawati', 'Wuntat Wiranto']
